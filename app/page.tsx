...
export default function Home() {
  return (
    ...
    {/* left side starts */}
     ...
     {/* middle side starts */}
     <div className="rounded-full p-4 border-solid border-cyan-500 border-[8px] bg-white w-[280px]  h-[280px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] flex justify-center items-center">
